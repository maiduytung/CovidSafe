...
public class Constants {
    ...
    public final static String REPORT_KEY = "REPORT_KEY";
    public final static String VACCINATION_KEY = "VACCINATION_KEY";
    public final static String CERTIFICATION_KEY = "CERTIFICATION_KEY";
    public final static String PROFILE_KEY = "PROFILE_KEY";
    public final static String OTP_KEY = "OTP";
    public final static String REGISTRATION = "REGISTRATION";
    public final static String SUBNATIONAL_DATA_FILENAME = "subnational.json";
    public final static String NATIONALITY_DATA_FILENAME = "nationality.json";
    public final static String ETHNIC_DATA_FILENAME = "ethnic.json";
    public final static String PRIORITY_DATA_FILENAME = "priority.json";
    public final static String SUBNATIONAL_TYPE_COUNTRY = "nuoc";
